...
func (Test) unit(ctx context.Context, coverage bool) error {
	args := []string{"-tags", "ci,memoryprotection", "-race", "-timeout", "20m", "-count=1"}
	if coverage {
...
func (Test) Integration(ctx context.Context) error {
	...
	return goTest(ctx, "./cmd/spicedb/memoryprotection/...", "-tags", "ci,image,memoryprotection", "-timeout", "30m")
}
