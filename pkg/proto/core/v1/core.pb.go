...
func (x *RelationTupleTreeNode) GetIntermediateNode() *SetOperationUserset {
	if x != nil {
		if x, ok := x.NodeType.(*RelationTupleTreeNode_IntermediateNode); ok {
...
func (x *RelationTupleTreeNode) GetLeafNode() *DirectSubjects {
	if x != nil {
		if x, ok := x.NodeType.(*RelationTupleTreeNode_LeafNode); ok {
			return x.LeafNode
		}
	}
	return nil
...
func (x *AllowedRelation) GetRelation() string {
	if x != nil {
		if x, ok := x.RelationOrWildcard.(*AllowedRelation_Relation); ok {
			return x.Relation
		}
	}
	return ""
...
func (x *AllowedRelation) GetPublicWildcard() *AllowedRelation_PublicWildcard {
	if x != nil {
		if x, ok := x.RelationOrWildcard.(*AllowedRelation_PublicWildcard_); ok {
...
func (x *UsersetRewrite) GetUnion() *SetOperation {
	if x != nil {
		if x, ok := x.RewriteOperation.(*UsersetRewrite_Union); ok {
			return x.Union
		}
	}
	return nil
...
func (x *UsersetRewrite) GetIntersection() *SetOperation {
	if x != nil {
		if x, ok := x.RewriteOperation.(*UsersetRewrite_Intersection); ok {
...
func (x *UsersetRewrite) GetExclusion() *SetOperation {
	if x != nil {
		if x, ok := x.RewriteOperation.(*UsersetRewrite_Exclusion); ok {
			return x.Exclusion
		}
	}
	return nil
...
func (x *CaveatExpression) GetOperation() *CaveatOperation {
	if x != nil {
		if x, ok := x.OperationOrCaveat.(*CaveatExpression_Operation); ok {
			return x.Operation
		}
	}
	return nil
...
func (x *CaveatExpression) GetCaveat() *ContextualizedCaveat {
	if x != nil {
		if x, ok := x.OperationOrCaveat.(*CaveatExpression_Caveat); ok {
			return x.Caveat
		}
	}
	return nil
...
func (x *SetOperation_Child) GetXThis() *SetOperation_Child_This {
	if x != nil {
		if x, ok := x.ChildType.(*SetOperation_Child_XThis); ok {
			return x.XThis
		}
	}
	return nil
...
func (x *SetOperation_Child) GetComputedUserset() *ComputedUserset {
	if x != nil {
		if x, ok := x.ChildType.(*SetOperation_Child_ComputedUserset); ok {
			return x.ComputedUserset
		}
	}
	return nil
...
func (x *SetOperation_Child) GetTupleToUserset() *TupleToUserset {
	if x != nil {
		if x, ok := x.ChildType.(*SetOperation_Child_TupleToUserset); ok {
...
func (x *SetOperation_Child) GetUsersetRewrite() *UsersetRewrite {
	if x != nil {
		if x, ok := x.ChildType.(*SetOperation_Child_UsersetRewrite); ok {
			return x.UsersetRewrite
		}
	}
	return nil
...
func (x *SetOperation_Child) GetFunctionedTupleToUserset() *FunctionedTupleToUserset {
	if x != nil {
		if x, ok := x.ChildType.(*SetOperation_Child_FunctionedTupleToUserset); ok {
...
func (x *SetOperation_Child) GetXNil() *SetOperation_Child_Nil {
	if x != nil {
		if x, ok := x.ChildType.(*SetOperation_Child_XNil); ok {
			return x.XNil
		}
	}
	return nil
